...
const vnx::Hash64 TcpServerBase::VNX_CODE_HASH(0x585d9cf382e8df1cull);
...
vnx::Hash64 TcpServerBase::get_type_hash() const {
	return VNX_TYPE_HASH;
}

std::string TcpServerBase::get_type_name() const {
	return "vnx.addons.TcpServer";
}

const vnx::TypeCode* TcpServerBase::get_type_code() const {
	return vnx::addons::vnx_native_type_code_TcpServerBase;
}

void TcpServerBase::accept(vnx::Visitor& _visitor) const {
	const vnx::TypeCode* _type_code = vnx::addons::vnx_native_type_code_TcpServerBase;
...
void TcpServerBase::write(std::ostream& _out) const {
	_out << "{";
...
void TcpServerBase::read(std::istream& _in) {
	if(auto _json = vnx::read_json(_in)) {
		from_object(_json->to_object());
	}
}

vnx::Object TcpServerBase::to_object() const {
	vnx::Object _object;
	_object["__type"] = "vnx.addons.TcpServer";
	_object["port"] = port;
	_object["host"] = host;
...
void TcpServerBase::from_object(const vnx::Object& _object) {
...
vnx::Variant TcpServerBase::get_field(const std::string& _name) const {
	if(_name == "port") {
...
void TcpServerBase::set_field(const std::string& _name, const vnx::Variant& _value) {
	if(_name == "port") {
		_value.to(port);
	} else if(_name == "host") {
		_value.to(host);
...
/// \private
std::ostream& operator<<(std::ostream& _out, const TcpServerBase& _value) {
	_value.write(_out);
	return _out;
}

/// \private
std::istream& operator>>(std::istream& _in, TcpServerBase& _value) {
	_value.read(_in);
	return _in;
}

const vnx::TypeCode* TcpServerBase::static_get_type_code() {
...
std::shared_ptr<vnx::TypeCode> TcpServerBase::static_create_type_code() {
	auto type_code = std::make_shared<vnx::TypeCode>();
	type_code->name = "vnx.addons.TcpServer";
	type_code->type_hash = vnx::Hash64(0x336d98e915472200ull);
	type_code->code_hash = vnx::Hash64(0x585d9cf382e8df1cull);
...
void TcpServerBase::vnx_handle_switch(std::shared_ptr<const vnx::Value> _value) {
...
std::shared_ptr<vnx::Value> TcpServerBase::vnx_call_switch(std::shared_ptr<const vnx::Value> _method, const vnx::request_id_t& _request_id) {
...
void write(TypeOutput& out, const ::vnx::addons::TcpServerBase& value, const TypeCode* type_code, const uint16_t* code) {
	...
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = vnx::addons::vnx_native_type_code_TcpServerBase;
		out.write_type_code(type_code);
		vnx::write_class_header<::vnx::addons::TcpServerBase>(out);
	}
