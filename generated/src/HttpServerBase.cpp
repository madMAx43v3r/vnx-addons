...
const vnx::Hash64 HttpServerBase::VNX_CODE_HASH(0x57ab794bd265d5caull);
	...
	:	Module::Module(_vnx_name)
{
	...
	vnx::read_config(vnx_name + ".deflate_level", deflate_level);
	vnx::read_config(vnx_name + ".max_connections", max_connections);
...
void HttpServerBase::accept(vnx::Visitor& _visitor) const {
	...
	_visitor.type_field(_type_code->fields[13], 13); vnx::accept(_visitor, deflate_level);
	_visitor.type_field(_type_code->fields[14], 14); vnx::accept(_visitor, max_connections);
	_visitor.type_field(_type_code->fields[15], 15); vnx::accept(_visitor, listen_queue_size);
	_visitor.type_field(_type_code->fields[16], 16); vnx::accept(_visitor, stats_interval_ms);
	_visitor.type_field(_type_code->fields[17], 17); vnx::accept(_visitor, connection_timeout_ms);
	_visitor.type_field(_type_code->fields[18], 18); vnx::accept(_visitor, session_timeout);
	_visitor.type_field(_type_code->fields[19], 19); vnx::accept(_visitor, max_payload_size);
	_visitor.type_field(_type_code->fields[20], 20); vnx::accept(_visitor, max_chunk_size);
	_visitor.type_field(_type_code->fields[21], 21); vnx::accept(_visitor, min_compress_size);
	_visitor.type_field(_type_code->fields[22], 22); vnx::accept(_visitor, do_compress);
	_visitor.type_field(_type_code->fields[23], 23); vnx::accept(_visitor, components);
	_visitor.type_field(_type_code->fields[24], 24); vnx::accept(_visitor, charset);
	_visitor.type_field(_type_code->fields[25], 25); vnx::accept(_visitor, add_headers);
	_visitor.type_field(_type_code->fields[26], 26); vnx::accept(_visitor, token_map);
	_visitor.type_field(_type_code->fields[27], 27); vnx::accept(_visitor, default_access);
	_visitor.type_field(_type_code->fields[28], 28); vnx::accept(_visitor, cookie_policy);
	_visitor.type_field(_type_code->fields[29], 29); vnx::accept(_visitor, session_coookie_name);
	_visitor.type_field(_type_code->fields[30], 30); vnx::accept(_visitor, token_header_name);
	_visitor.type_field(_type_code->fields[31], 31); vnx::accept(_visitor, login_path);
	_visitor.type_field(_type_code->fields[32], 32); vnx::accept(_visitor, logout_path);
	_visitor.type_field(_type_code->fields[33], 33); vnx::accept(_visitor, session_path);
...
void HttpServerBase::write(std::ostream& _out) const {
	...
	_out << ", \"deflate_level\": "; vnx::write(_out, deflate_level);
...
vnx::Object HttpServerBase::to_object() const {
	...
	_object["deflate_level"] = deflate_level;
...
void HttpServerBase::from_object(const vnx::Object& _object) {
	for(const auto& _entry : _object.field) {
		...
		} else if(_entry.first == "deflate_level") {
			_entry.second.to(deflate_level);
...
vnx::Variant HttpServerBase::get_field(const std::string& _name) const {
	...
	if(_name == "deflate_level") {
		return vnx::Variant(deflate_level);
	}
...
void HttpServerBase::set_field(const std::string& _name, const vnx::Variant& _value) {
	...
	} else if(_name == "deflate_level") {
		_value.to(deflate_level);
...
std::shared_ptr<vnx::TypeCode> HttpServerBase::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0x57ab794bd265d5caull);
...
void read(TypeInput& in, ::vnx::addons::HttpServerBase& value, const TypeCode* type_code, const uint16_t* code) {
	...
	if(type_code->is_matched) {
		...
		if(const auto* const _field = type_code->field_map[13]) {
			vnx::read_value(_buf + _field->offset, value.deflate_level, _field->code.data());
		}
	...
	for(const auto* _field : type_code->ext_fields) {
		switch(_field->native_index) {
			...
			case 22: vnx::read(in, value.do_compress, type_code, _field->code.data()); break;
			case 23: vnx::read(in, value.components, type_code, _field->code.data()); break;
			case 24: vnx::read(in, value.charset, type_code, _field->code.data()); break;
			case 25: vnx::read(in, value.add_headers, type_code, _field->code.data()); break;
			case 26: vnx::read(in, value.token_map, type_code, _field->code.data()); break;
			case 27: vnx::read(in, value.default_access, type_code, _field->code.data()); break;
			case 28: vnx::read(in, value.cookie_policy, type_code, _field->code.data()); break;
			case 29: vnx::read(in, value.session_coookie_name, type_code, _field->code.data()); break;
			case 30: vnx::read(in, value.token_header_name, type_code, _field->code.data()); break;
			case 31: vnx::read(in, value.login_path, type_code, _field->code.data()); break;
			case 32: vnx::read(in, value.logout_path, type_code, _field->code.data()); break;
			case 33: vnx::read(in, value.session_path, type_code, _field->code.data()); break;
...
void write(TypeOutput& out, const ::vnx::addons::HttpServerBase& value, const TypeCode* type_code, const uint16_t* code) {
	...
	vnx::write_value(_buf + 19, value.deflate_level);
	vnx::write_value(_buf + 23, value.max_connections);
	vnx::write_value(_buf + 27, value.listen_queue_size);
	vnx::write_value(_buf + 31, value.stats_interval_ms);
	vnx::write_value(_buf + 35, value.connection_timeout_ms);
	vnx::write_value(_buf + 39, value.session_timeout);
	vnx::write_value(_buf + 47, value.max_payload_size);
	vnx::write_value(_buf + 55, value.max_chunk_size);
	vnx::write_value(_buf + 63, value.min_compress_size);
	...
	vnx::write(out, value.do_compress, type_code, type_code->fields[22].code.data());
	vnx::write(out, value.components, type_code, type_code->fields[23].code.data());
	vnx::write(out, value.charset, type_code, type_code->fields[24].code.data());
	vnx::write(out, value.add_headers, type_code, type_code->fields[25].code.data());
	vnx::write(out, value.token_map, type_code, type_code->fields[26].code.data());
	vnx::write(out, value.default_access, type_code, type_code->fields[27].code.data());
	vnx::write(out, value.cookie_policy, type_code, type_code->fields[28].code.data());
	vnx::write(out, value.session_coookie_name, type_code, type_code->fields[29].code.data());
	vnx::write(out, value.token_header_name, type_code, type_code->fields[30].code.data());
	vnx::write(out, value.login_path, type_code, type_code->fields[31].code.data());
	vnx::write(out, value.logout_path, type_code, type_code->fields[32].code.data());
	vnx::write(out, value.session_path, type_code, type_code->fields[33].code.data());
}
