...
HttpClientAsyncClient::HttpClientAsyncClient(const std::string& service_name)
	:	AsyncClient::AsyncClient(vnx::Hash64(service_name))
{
}

HttpClientAsyncClient::HttpClientAsyncClient(vnx::Hash64 service_addr)
	:	AsyncClient::AsyncClient(service_addr)
{
}

uint64_t HttpClientAsyncClient::get(const std::string& url, const ::vnx::addons::http_request_options_t& options, const std::function<void(std::shared_ptr<const ::vnx::addons::HttpResponse>)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
	...
	const auto _request_id = ++vnx_next_id;
	{
		...
		vnx_queue_get[_request_id] = std::make_pair(_callback, _error_callback);
	}
...
uint64_t HttpClientAsyncClient::post_json(const std::string& url, const std::string& data, const ::vnx::addons::http_request_options_t& options, const std::function<void(std::shared_ptr<const ::vnx::addons::HttpResponse>)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t HttpClientAsyncClient::post_text(const std::string& url, const std::string& data, const ::vnx::addons::http_request_options_t& options, const std::function<void(std::shared_ptr<const ::vnx::addons::HttpResponse>)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t HttpClientAsyncClient::vnx_get_config_object(const std::function<void(const ::vnx::Object&)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t HttpClientAsyncClient::vnx_get_config(const std::string& name, const std::function<void(const ::vnx::Variant&)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t HttpClientAsyncClient::vnx_set_config_object(const ::vnx::Object& config, const std::function<void()>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t HttpClientAsyncClient::vnx_set_config(const std::string& name, const ::vnx::Variant& value, const std::function<void()>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t HttpClientAsyncClient::vnx_get_type_code(const std::function<void(const ::vnx::TypeCode&)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t HttpClientAsyncClient::vnx_get_module_info(const std::function<void(std::shared_ptr<const ::vnx::ModuleInfo>)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t HttpClientAsyncClient::vnx_restart(const std::function<void()>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t HttpClientAsyncClient::vnx_stop(const std::function<void()>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t HttpClientAsyncClient::vnx_self_test(const std::function<void(const vnx::bool_t&)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
int32_t HttpClientAsyncClient::vnx_purge_request(uint64_t _request_id, const vnx::exception& _ex) {
	...
	switch(_index) {
		case 0: {
			const auto _iter = vnx_queue_get.find(_request_id);
			if(_iter != vnx_queue_get.end()) {
				const auto _callback = std::move(_iter->second.second);
				vnx_queue_get.erase(_iter);
				_lock.unlock();
				if(_callback) {
					_callback(_ex);
				}
		...
		case 4: {
			...
			if(_iter != vnx_queue_post_json.end()) {
				const auto _callback = std::move(_iter->second.second);
				vnx_queue_post_json.erase(_iter);
				_lock.unlock();
				if(_callback) {
					_callback(_ex);
				}
		...
		case 5: {
			...
			if(_iter != vnx_queue_post_text.end()) {
				const auto _callback = std::move(_iter->second.second);
				vnx_queue_post_text.erase(_iter);
				_lock.unlock();
				if(_callback) {
					_callback(_ex);
				}
...
int32_t HttpClientAsyncClient::vnx_callback_switch(uint64_t _request_id, std::shared_ptr<const vnx::Value> _value) {
	std::unique_lock<std::mutex> _lock(vnx_mutex);
	const auto _iter = vnx_pending.find(_request_id);
	if(_iter == vnx_pending.end()) {
		throw std::runtime_error("HttpClientAsyncClient: received unknown return");
	}
	const auto _index = _iter->second;
	vnx_pending.erase(_iter);
	switch(_index) {
		case 0: {
			...
			_lock.unlock();
			if(_callback) {
				if(auto _result = std::dynamic_pointer_cast<const ::vnx::addons::HttpClient_get_return>(_value)) {
		...
		case 3: {
			...
			_lock.unlock();
			if(_callback) {
				if(auto _result = std::dynamic_pointer_cast<const ::vnx::addons::HttpClient_post_return>(_value)) {
					_callback(_result->_ret_0);
				} else if(_value && !_value->is_void()) {
					_callback(_value->get_field_by_index(0).to<std::shared_ptr<const ::vnx::addons::HttpResponse>>());
				} else {
		...
		case 4: {
			...
			_lock.unlock();
			if(_callback) {
				if(auto _result = std::dynamic_pointer_cast<const ::vnx::addons::HttpClient_post_json_return>(_value)) {
					_callback(_result->_ret_0);
				} else if(_value && !_value->is_void()) {
					_callback(_value->get_field_by_index(0).to<std::shared_ptr<const ::vnx::addons::HttpResponse>>());
				} else {
		...
		case 5: {
			...
			_lock.unlock();
			if(_callback) {
				if(auto _result = std::dynamic_pointer_cast<const ::vnx::addons::HttpClient_post_text_return>(_value)) {
					_callback(_result->_ret_0);
				} else if(_value && !_value->is_void()) {
					_callback(_value->get_field_by_index(0).to<std::shared_ptr<const ::vnx::addons::HttpResponse>>());
				} else {
		...
		default:
			if(_index >= 0) {
				throw std::logic_error("HttpClientAsyncClient: invalid callback index");
			}
	}
	return _index;
}
