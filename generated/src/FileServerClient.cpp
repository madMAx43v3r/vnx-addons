...
::vnx::Buffer FileServerClient::read_file_range(const std::string& path, const int64_t& offset, const int64_t& length) {
	...
	auto _return_value = vnx_request(_method, false);
	auto _result = std::dynamic_pointer_cast<const ::vnx::addons::FileServer_read_file_range_return>(_return_value);
	if(!_result) {
		throw std::logic_error("FileServerClient: !_result");
	}
	return _result->_ret_0;
...
::vnx::addons::file_info_t FileServerClient::get_file_info(const std::string& path) {
	...
	_method->path = path;
	auto _return_value = vnx_request(_method, false);
	auto _result = std::dynamic_pointer_cast<const ::vnx::addons::FileServer_get_file_info_return>(_return_value);
	if(!_result) {
		throw std::logic_error("FileServerClient: !_result");
	}
	return _result->_ret_0;
...
std::vector<::vnx::addons::file_info_t> FileServerClient::read_directory(const std::string& path) {
	...
	_method->path = path;
	auto _return_value = vnx_request(_method, false);
	auto _result = std::dynamic_pointer_cast<const ::vnx::addons::FileServer_read_directory_return>(_return_value);
	if(!_result) {
		throw std::logic_error("FileServerClient: !_result");
	}
	return _result->_ret_0;
