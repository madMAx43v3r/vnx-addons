...
const vnx::Hash64 HttpClientBase::VNX_TYPE_HASH(0xda72143ea1487390ull);
const vnx::Hash64 HttpClientBase::VNX_CODE_HASH(0xbb7c9d5eb7319abdull);

HttpClientBase::HttpClientBase(const std::string& _vnx_name)
...
vnx::Hash64 HttpClientBase::get_type_hash() const {
	return VNX_TYPE_HASH;
}

std::string HttpClientBase::get_type_name() const {
	return "vnx.addons.HttpClient";
}

const vnx::TypeCode* HttpClientBase::get_type_code() const {
	return vnx::addons::vnx_native_type_code_HttpClientBase;
}

void HttpClientBase::accept(vnx::Visitor& _visitor) const {
	const vnx::TypeCode* _type_code = vnx::addons::vnx_native_type_code_HttpClientBase;
	...
	_visitor.type_field(_type_code->fields[11], 11); vnx::accept(_visitor, output_response);
	_visitor.type_field(_type_code->fields[12], 12); vnx::accept(_visitor, max_payload_size);
	_visitor.type_end(*_type_code);
}

void HttpClientBase::write(std::ostream& _out) const {
	_out << "{";
...
void HttpClientBase::read(std::istream& _in) {
	if(auto _json = vnx::read_json(_in)) {
		from_object(_json->to_object());
	}
}

vnx::Object HttpClientBase::to_object() const {
	vnx::Object _object;
	_object["__type"] = "vnx.addons.HttpClient";
	_object["port"] = port;
	_object["host"] = host;
...
void HttpClientBase::from_object(const vnx::Object& _object) {
...
vnx::Variant HttpClientBase::get_field(const std::string& _name) const {
	if(_name == "port") {
...
void HttpClientBase::set_field(const std::string& _name, const vnx::Variant& _value) {
	if(_name == "port") {
		_value.to(port);
	} else if(_name == "host") {
		_value.to(host);
...
/// \private
std::ostream& operator<<(std::ostream& _out, const HttpClientBase& _value) {
	_value.write(_out);
	return _out;
}

/// \private
std::istream& operator>>(std::istream& _in, HttpClientBase& _value) {
	_value.read(_in);
	return _in;
}

const vnx::TypeCode* HttpClientBase::static_get_type_code() {
...
std::shared_ptr<vnx::TypeCode> HttpClientBase::static_create_type_code() {
	auto type_code = std::make_shared<vnx::TypeCode>();
	type_code->name = "vnx.addons.HttpClient";
	type_code->type_hash = vnx::Hash64(0xda72143ea1487390ull);
	type_code->code_hash = vnx::Hash64(0xbb7c9d5eb7319abdull);
...
void HttpClientBase::vnx_handle_switch(std::shared_ptr<const vnx::Value> _value) {
...
std::shared_ptr<vnx::Value> HttpClientBase::vnx_call_switch(std::shared_ptr<const vnx::Value> _method, const vnx::request_id_t& _request_id) {
	switch(_method->get_type_hash()) {
		...
		case 0xa1ae3645458beb92ull: {
			auto _args = std::static_pointer_cast<const ::vnx::addons::HttpClient_get>(_method);
		...
		case 0x24279bfc48ad24e7ull: {
			auto _args = std::static_pointer_cast<const ::vnx::addons::HttpClient_post_json>(_method);
			post_json_async(_args->url, _args->data, _args->options, _request_id);
			return nullptr;
		}
		case 0xfe8f5b2f275a8496ull: {
			auto _args = std::static_pointer_cast<const ::vnx::addons::HttpClient_post_text>(_method);
			post_text_async(_args->url, _args->data, _args->options, _request_id);
			return nullptr;
		}
	}
...
void HttpClientBase::post_async_return(const vnx::request_id_t& _request_id, const std::shared_ptr<const ::vnx::addons::HttpResponse>& _ret_0) const {
	auto _return_value = ::vnx::addons::HttpClient_post_return::create();
	_return_value->_ret_0 = _ret_0;
	vnx_async_return(_request_id, _return_value);
}

void HttpClientBase::post_json_async_return(const vnx::request_id_t& _request_id, const std::shared_ptr<const ::vnx::addons::HttpResponse>& _ret_0) const {
	auto _return_value = ::vnx::addons::HttpClient_post_json_return::create();
	_return_value->_ret_0 = _ret_0;
	vnx_async_return(_request_id, _return_value);
}

void HttpClientBase::post_text_async_return(const vnx::request_id_t& _request_id, const std::shared_ptr<const ::vnx::addons::HttpResponse>& _ret_0) const {
	auto _return_value = ::vnx::addons::HttpClient_post_text_return::create();
	_return_value->_ret_0 = _ret_0;
	vnx_async_return(_request_id, _return_value);
}
...
void read(TypeInput& in, ::vnx::addons::HttpClientBase& value, const TypeCode* type_code, const uint16_t* code) {
	...
	for(const auto* _field : type_code->ext_fields) {
		switch(_field->native_index) {
			...
			case 11: vnx::read(in, value.output_response, type_code, _field->code.data()); break;
...
void write(TypeOutput& out, const ::vnx::addons::HttpClientBase& value, const TypeCode* type_code, const uint16_t* code) {
	...
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = vnx::addons::vnx_native_type_code_HttpClientBase;
		out.write_type_code(type_code);
		vnx::write_class_header<::vnx::addons::HttpClientBase>(out);
	}
	else if(code && code[0] == CODE_STRUCT) {
		type_code = type_code->depends[code[1]];
	}
	auto* const _buf = out.write(39);
	...
	vnx::write_value(_buf + 31, value.max_payload_size);
	vnx::write(out, value.host, type_code, type_code->fields[1].code.data());
	vnx::write(out, value.output_response, type_code, type_code->fields[11].code.data());
}
