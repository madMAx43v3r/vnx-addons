...
const TypeCode* type<::vnx::addons::CompressedValue_decompress>::get_type_code() {
	return vnx::addons::vnx_native_type_code_CompressedValue_decompress;
}

void type<::vnx::addons::CompressedValue_decompress>::create_dynamic_code(std::vector<uint16_t>& code) {
	create_dynamic_code(code, ::vnx::addons::CompressedValue_decompress());
}

void type<::vnx::addons::CompressedValue_decompress>::create_dynamic_code(std::vector<uint16_t>& code, const ::vnx::addons::CompressedValue_decompress& value, bool special) {
	code.push_back(CODE_OBJECT);
}

const TypeCode* type<::vnx::addons::CompressedValue_decompress_return>::get_type_code() {
	return vnx::addons::vnx_native_type_code_CompressedValue_decompress_return;
}

void type<::vnx::addons::CompressedValue_decompress_return>::create_dynamic_code(std::vector<uint16_t>& code) {
	create_dynamic_code(code, ::vnx::addons::CompressedValue_decompress_return());
}

void type<::vnx::addons::CompressedValue_decompress_return>::create_dynamic_code(std::vector<uint16_t>& code, const ::vnx::addons::CompressedValue_decompress_return& value, bool special) {
	code.push_back(CODE_OBJECT);
}

const TypeCode* type<::vnx::addons::CompressedValue_vnx_decompress>::get_type_code() {
	return vnx::addons::vnx_native_type_code_CompressedValue_vnx_decompress;
}

void type<::vnx::addons::CompressedValue_vnx_decompress>::create_dynamic_code(std::vector<uint16_t>& code) {
	create_dynamic_code(code, ::vnx::addons::CompressedValue_vnx_decompress());
}

void type<::vnx::addons::CompressedValue_vnx_decompress>::create_dynamic_code(std::vector<uint16_t>& code, const ::vnx::addons::CompressedValue_vnx_decompress& value, bool special) {
	code.push_back(CODE_OBJECT);
}

const TypeCode* type<::vnx::addons::CompressedValue_vnx_decompress_return>::get_type_code() {
	return vnx::addons::vnx_native_type_code_CompressedValue_vnx_decompress_return;
}

void type<::vnx::addons::CompressedValue_vnx_decompress_return>::create_dynamic_code(std::vector<uint16_t>& code) {
	create_dynamic_code(code, ::vnx::addons::CompressedValue_vnx_decompress_return());
}

void type<::vnx::addons::CompressedValue_vnx_decompress_return>::create_dynamic_code(std::vector<uint16_t>& code, const ::vnx::addons::CompressedValue_vnx_decompress_return& value, bool special) {
	code.push_back(CODE_OBJECT);
}
...
const TypeCode* type<::vnx::addons::DeflatedValue_decompress>::get_type_code() {
	return vnx::addons::vnx_native_type_code_DeflatedValue_decompress;
}

void type<::vnx::addons::DeflatedValue_decompress>::create_dynamic_code(std::vector<uint16_t>& code) {
	create_dynamic_code(code, ::vnx::addons::DeflatedValue_decompress());
}

void type<::vnx::addons::DeflatedValue_decompress>::create_dynamic_code(std::vector<uint16_t>& code, const ::vnx::addons::DeflatedValue_decompress& value, bool special) {
	code.push_back(CODE_OBJECT);
}

const TypeCode* type<::vnx::addons::DeflatedValue_decompress_return>::get_type_code() {
	return vnx::addons::vnx_native_type_code_DeflatedValue_decompress_return;
}

void type<::vnx::addons::DeflatedValue_decompress_return>::create_dynamic_code(std::vector<uint16_t>& code) {
	create_dynamic_code(code, ::vnx::addons::DeflatedValue_decompress_return());
}

void type<::vnx::addons::DeflatedValue_decompress_return>::create_dynamic_code(std::vector<uint16_t>& code, const ::vnx::addons::DeflatedValue_decompress_return& value, bool special) {
	code.push_back(CODE_OBJECT);
}
...
const TypeCode* type<::vnx::addons::HttpRequest_get_header_value>::get_type_code() {
	return vnx::addons::vnx_native_type_code_HttpRequest_get_header_value;
}

void type<::vnx::addons::HttpRequest_get_header_value>::create_dynamic_code(std::vector<uint16_t>& code) {
	create_dynamic_code(code, ::vnx::addons::HttpRequest_get_header_value());
}

void type<::vnx::addons::HttpRequest_get_header_value>::create_dynamic_code(std::vector<uint16_t>& code, const ::vnx::addons::HttpRequest_get_header_value& value, bool special) {
	code.push_back(CODE_OBJECT);
}

const TypeCode* type<::vnx::addons::HttpRequest_get_header_value_return>::get_type_code() {
	return vnx::addons::vnx_native_type_code_HttpRequest_get_header_value_return;
}

void type<::vnx::addons::HttpRequest_get_header_value_return>::create_dynamic_code(std::vector<uint16_t>& code) {
	create_dynamic_code(code, ::vnx::addons::HttpRequest_get_header_value_return());
}

void type<::vnx::addons::HttpRequest_get_header_value_return>::create_dynamic_code(std::vector<uint16_t>& code, const ::vnx::addons::HttpRequest_get_header_value_return& value, bool special) {
	code.push_back(CODE_OBJECT);
}
...
void register_all_types() {
	...
	vnx::register_type_code(::vnx::addons::CompressedValue_vnx_decompress::static_create_type_code());
	vnx::register_type_code(::vnx::addons::CompressedValue_vnx_decompress_return::static_create_type_code());
	vnx::register_type_code(::vnx::addons::DeflatedValue::static_create_type_code());
	vnx::register_type_code(::vnx::addons::DeflatedValue_decompress::static_create_type_code());
	vnx::register_type_code(::vnx::addons::DeflatedValue_decompress_return::static_create_type_code());
	...
	vnx::register_type_code(::vnx::addons::HttpRequest_get_header_value::static_create_type_code());
	vnx::register_type_code(::vnx::addons::HttpRequest_get_header_value_return::static_create_type_code());
...
const vnx::TypeCode* const vnx_native_type_code_CompressedValue_decompress = vnx::get_type_code(vnx::Hash64(0x46eb7f9563805f83ull));
const vnx::TypeCode* const vnx_native_type_code_CompressedValue_decompress_return = vnx::get_type_code(vnx::Hash64(0xe82bd43034255655ull));
const vnx::TypeCode* const vnx_native_type_code_CompressedValue_vnx_decompress = vnx::get_type_code(vnx::Hash64(0xf90e352a977e7f9cull));
const vnx::TypeCode* const vnx_native_type_code_CompressedValue_vnx_decompress_return = vnx::get_type_code(vnx::Hash64(0x7520fbc43e0fae4eull));
const vnx::TypeCode* const vnx_native_type_code_DeflatedValue = vnx::get_type_code(vnx::Hash64(0xe3d58522f6fb225dull));
const vnx::TypeCode* const vnx_native_type_code_DeflatedValue_decompress = vnx::get_type_code(vnx::Hash64(0x77db9a2569c776b5ull));
const vnx::TypeCode* const vnx_native_type_code_DeflatedValue_decompress_return = vnx::get_type_code(vnx::Hash64(0x6935e4a345bdcdc5ull));
...
const vnx::TypeCode* const vnx_native_type_code_HttpRequest_get_header_value = vnx::get_type_code(vnx::Hash64(0x34cb501935178974ull));
const vnx::TypeCode* const vnx_native_type_code_HttpRequest_get_header_value_return = vnx::get_type_code(vnx::Hash64(0x4d4b3da0d03bb3d1ull));
