...
#include <vnx/addons/HttpBalancerClient.hxx>
...
HttpBalancerClient::HttpBalancerClient(const std::string& service_name)
	:	Client::Client(vnx::Hash64(service_name))
{
}

HttpBalancerClient::HttpBalancerClient(vnx::Hash64 service_addr)
	:	Client::Client(service_addr)
{
}

std::shared_ptr<const ::vnx::addons::HttpResponse> HttpBalancerClient::http_request(std::shared_ptr<const ::vnx::addons::HttpRequest> request, const std::string& sub_path) {
	...
	if(auto _result = std::dynamic_pointer_cast<const ::vnx::addons::HttpComponent_http_request_return>(_return_value)) {
		...
		throw std::logic_error("HttpBalancerClient: invalid return value");
	}
}

std::shared_ptr<const ::vnx::addons::HttpData> HttpBalancerClient::http_request_chunk(std::shared_ptr<const ::vnx::addons::HttpRequest> request, const std::string& sub_path, const int64_t& offset, const int64_t& max_bytes) {
...
::vnx::Object HttpBalancerClient::vnx_get_config_object() {
...
::vnx::Variant HttpBalancerClient::vnx_get_config(const std::string& name) {
...
void HttpBalancerClient::vnx_set_config_object(const ::vnx::Object& config) {
	auto _method = ::vnx::ModuleInterface_vnx_set_config_object::create();
	_method->config = config;
	vnx_request(_method, false);
}

void HttpBalancerClient::vnx_set_config_object_async(const ::vnx::Object& config) {
	auto _method = ::vnx::ModuleInterface_vnx_set_config_object::create();
	_method->config = config;
	vnx_request(_method, true);
}

void HttpBalancerClient::vnx_set_config(const std::string& name, const ::vnx::Variant& value) {
...
void HttpBalancerClient::vnx_set_config_async(const std::string& name, const ::vnx::Variant& value) {
	auto _method = ::vnx::ModuleInterface_vnx_set_config::create();
	_method->name = name;
	_method->value = value;
	vnx_request(_method, true);
...
::vnx::TypeCode HttpBalancerClient::vnx_get_type_code() {
...
std::shared_ptr<const ::vnx::ModuleInfo> HttpBalancerClient::vnx_get_module_info() {
...
void HttpBalancerClient::vnx_restart() {
	auto _method = ::vnx::ModuleInterface_vnx_restart::create();
	vnx_request(_method, false);
}

void HttpBalancerClient::vnx_restart_async() {
	auto _method = ::vnx::ModuleInterface_vnx_restart::create();
	vnx_request(_method, true);
}

void HttpBalancerClient::vnx_stop() {
	auto _method = ::vnx::ModuleInterface_vnx_stop::create();
	vnx_request(_method, false);
}

void HttpBalancerClient::vnx_stop_async() {
	auto _method = ::vnx::ModuleInterface_vnx_stop::create();
	vnx_request(_method, true);
}

vnx::bool_t HttpBalancerClient::vnx_self_test() {
