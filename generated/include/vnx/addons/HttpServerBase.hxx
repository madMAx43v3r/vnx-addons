...
void HttpServerBase::accept_generic(T& _visitor) const {
	_visitor.template type_begin<HttpServerBase>(34);
	...
	_visitor.type_field("max_connections", 14); _visitor.accept(max_connections);
	_visitor.type_field("listen_queue_size", 15); _visitor.accept(listen_queue_size);
	_visitor.type_field("stats_interval_ms", 16); _visitor.accept(stats_interval_ms);
	_visitor.type_field("connection_timeout_ms", 17); _visitor.accept(connection_timeout_ms);
	_visitor.type_field("session_timeout", 18); _visitor.accept(session_timeout);
	_visitor.type_field("max_payload_size", 19); _visitor.accept(max_payload_size);
	_visitor.type_field("max_chunk_size", 20); _visitor.accept(max_chunk_size);
	_visitor.type_field("min_compress_size", 21); _visitor.accept(min_compress_size);
	_visitor.type_field("do_compress", 22); _visitor.accept(do_compress);
	_visitor.type_field("components", 23); _visitor.accept(components);
	_visitor.type_field("charset", 24); _visitor.accept(charset);
	_visitor.type_field("add_headers", 25); _visitor.accept(add_headers);
	_visitor.type_field("token_map", 26); _visitor.accept(token_map);
	_visitor.type_field("default_access", 27); _visitor.accept(default_access);
	_visitor.type_field("cookie_policy", 28); _visitor.accept(cookie_policy);
	_visitor.type_field("session_coookie_name", 29); _visitor.accept(session_coookie_name);
	_visitor.type_field("token_header_name", 30); _visitor.accept(token_header_name);
	_visitor.type_field("login_path", 31); _visitor.accept(login_path);
	_visitor.type_field("logout_path", 32); _visitor.accept(logout_path);
	_visitor.type_field("session_path", 33); _visitor.accept(session_path);
	_visitor.template type_end<HttpServerBase>(34);
}
