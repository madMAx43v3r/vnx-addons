...
#ifndef INCLUDE_vnx_addons_HttpClient_ASYNC_CLIENT_HXX_
#define INCLUDE_vnx_addons_HttpClient_ASYNC_CLIENT_HXX_
...
class HttpClientAsyncClient : public vnx::AsyncClient {
public:
	HttpClientAsyncClient(const std::string& service_name);
	
	HttpClientAsyncClient(vnx::Hash64 service_addr);
	...
	uint64_t post_json(const std::string& url = "", const std::string& data = "", const ::vnx::addons::http_request_options_t& options = ::vnx::addons::http_request_options_t(), 
			const std::function<void(std::shared_ptr<const ::vnx::addons::HttpResponse>)>& _callback = std::function<void(std::shared_ptr<const ::vnx::addons::HttpResponse>)>(),
			const std::function<void(const vnx::exception&)>& _error_callback = std::function<void(const vnx::exception&)>());
	
	uint64_t post_text(const std::string& url = "", const std::string& data = "", const ::vnx::addons::http_request_options_t& options = ::vnx::addons::http_request_options_t(), 
			const std::function<void(std::shared_ptr<const ::vnx::addons::HttpResponse>)>& _callback = std::function<void(std::shared_ptr<const ::vnx::addons::HttpResponse>)>(),
			const std::function<void(const vnx::exception&)>& _error_callback = std::function<void(const vnx::exception&)>());
...
#endif // INCLUDE_vnx_addons_HttpClient_ASYNC_CLIENT_HXX_
