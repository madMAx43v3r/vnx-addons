...
#ifndef INCLUDE_vnx_addons_HttpBalancer_CLIENT_HXX_
#define INCLUDE_vnx_addons_HttpBalancer_CLIENT_HXX_
...
class HttpBalancerClient : public vnx::Client {
public:
	HttpBalancerClient(const std::string& service_name);
	
	HttpBalancerClient(vnx::Hash64 service_addr);
...
#endif // INCLUDE_vnx_addons_HttpBalancer_CLIENT_HXX_
