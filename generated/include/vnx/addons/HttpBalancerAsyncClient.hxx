...
#ifndef INCLUDE_vnx_addons_HttpBalancer_ASYNC_CLIENT_HXX_
#define INCLUDE_vnx_addons_HttpBalancer_ASYNC_CLIENT_HXX_
...
class HttpBalancerAsyncClient : public vnx::AsyncClient {
public:
	HttpBalancerAsyncClient(const std::string& service_name);
	
	HttpBalancerAsyncClient(vnx::Hash64 service_addr);
...
#endif // INCLUDE_vnx_addons_HttpBalancer_ASYNC_CLIENT_HXX_
